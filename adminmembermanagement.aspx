<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="adminmembermanagement.aspx.cs" Inherits="E_Book_Library.adminmembermanagement" %>
               ...
               <div class="card-body">
                  ...
                  <div class="row" style="margin: 9px 0 0 0;">
                     ...
                     <div class="col-8 mx-auto">
                        <asp:Button ID="Button2" class="btn btn-lg btn-block btn-danger" style ="height: auto;" runat="server" Text="Delete User Permanently" />
                     </div>
                  </div>
                   </center>
               </div>
